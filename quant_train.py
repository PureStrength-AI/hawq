...
def main_worker_gpt(gpu, ngpus_per_node, args):
    ...
    module_config = {
        ...
        'blocks.0.ln2': 2,
        'blocks.0.att': 2,
        'blocks.0.att.query': 2,
        'blocks.0.att.key': 2,
        'blocks.0.att.value': 2,
        'blocks.0.att.fc_out': 2,
        'blocks.0.att.quant_act': 2,
        'blocks.0.att.quant_act_int32': 16,
        'blocks.0.att.dropout': 2,
        'blocks.0.fcn': 2,
        'blocks.0.fcn.quant_act': 2,
        'blocks.0.fcn.quant_act_int32': 16,
        'blocks.0.fcn.linear1': 2,
        'blocks.0.fcn.linear2': 2,
        'blocks.0.fcn.activation': 2,
        'blocks.0.dropout': 2,
        'blocks.1': 2,
        'blocks.1.ln1': 2,
        'blocks.1.ln2': 2,
        'blocks.1.att': 2,
        'blocks.1.att.query': 2,
        'blocks.1.att.key': 2,
        'blocks.1.att.value': 2,
        'blocks.1.att.fc_out': 2,
        'blocks.1.att.quant_act': 2,
        'blocks.1.att.quant_act_int32': 16,
        'blocks.1.att.dropout': 2,
        'blocks.1.fcn': 2,
        'blocks.1.fcn.quant_act': 2,
        'blocks.1.fcn.quant_act_int32': 16,
        'blocks.1.fcn.linear1': 2,
        'blocks.1.fcn.linear2': 2,
        'blocks.1.fcn.activation': 2,
        'blocks.1.dropout': 2,
        'blocks.2': 2,
        'blocks.2.ln1': 2,
        'blocks.2.ln2': 2,
        'blocks.2.att': 2,
        'blocks.2.att.query': 2,
        'blocks.2.att.key': 2,
        'blocks.2.att.value': 2,
        'blocks.2.att.fc_out': 2,
        'blocks.2.att.quant_act': 2,
        'blocks.2.att.quant_act_int32': 16,
        'blocks.2.att.dropout': 2,
        'blocks.2.fcn': 2,
        'blocks.2.fcn.quant_act': 2,
        'blocks.2.fcn.quant_act_int32': 16,
        'blocks.2.fcn.linear1': 2,
        'blocks.2.fcn.linear2': 2,
        'blocks.2.fcn.activation': 2,
        'blocks.2.dropout': 2,
        'quant_act_output': 8,
        'quant_output': 8
    }
